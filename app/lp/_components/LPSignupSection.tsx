  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-[40px] border border-cyan-300/16 bg-[radial-gradient(120%_110%_at_20%_0%,rgba(34,211,238,0.16),rgba(10,22,38,0.88)_52%,rgba(7,16,30,0.96)_100%)] px-4 py-6 backdrop-blur-2xl sm:px-8 sm:py-10 lg:px-10 lg:py-10">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-cyan-200/42 to-transparent" />
        ...
        <div className="pointer-events-none absolute -left-16 top-10 h-48 w-48 rounded-full bg-cyan-300/7 blur-3xl animate-[lp-signup-ambient-drift_16s_ease-in-out_infinite]" />
        <div className="pointer-events-none absolute bottom-0 right-0 h-52 w-52 rounded-full bg-emerald-300/6 blur-3xl animate-[lp-signup-ambient-drift_20s_ease-in-out_infinite_reverse]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(120,220,255,0.14)_1px,transparent_1px),linear-gradient(90deg,rgba(120,220,255,0.14)_1px,transparent_1px)] bg-size-[42px_42px] opacity-[0.03]" />

        <div className="relative mx-auto max-w-6xl">
          <div className="mx-auto flex w-fit items-center gap-3 rounded-full border border-white/10 bg-white/4 px-4 py-2">
          ...
          <div className="relative mt-7 grid items-stretch gap-5 lg:grid-cols-[1.02fr_410px]">
            ...
            <div className="relative overflow-hidden rounded-[30px] border border-white/8 bg-[linear-gradient(180deg,rgba(7,17,34,0.84),rgba(6,16,28,0.78))] p-4 sm:p-6">
              <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-cyan-200/26 to-transparent" />
              <div className="pointer-events-none absolute inset-x-[10%] top-0 h-20 rounded-full bg-cyan-300/6 blur-3xl" />
              <div className="pointer-events-none absolute inset-px rounded-[29px] ring-1 ring-inset ring-white/5" />
              ...
              <div className="relative mt-0 rounded-[24px] border border-white/8 bg-white/3 p-3.5 sm:p-4 lg:mt-4">
                  ...
                  >
                    {FOCUS_POINTS.map((item, index) => (
                      ...
                      >
                        ...
                        <div
                          className={`group relative overflow-hidden rounded-[20px] border p-px transition duration-300 ${
                            index === 0
                        ...
                        >
                          <div className="relative rounded-[19px] bg-[linear-gradient(180deg,rgba(10,22,40,0.88),rgba(8,18,34,0.82))] px-4 py-2.5">
                            <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-cyan-200/22 to-transparent" />
                            <div
                              className={`pointer-events-none absolute left-0 top-0 h-full w-[3px] rounded-l-[19px] bg-linear-to-b from-cyan-300 via-sky-400 to-emerald-300 ${
              ...
              >
                <div
                  className="rounded-[20px] border border-white/8 bg-white/3 px-4 py-4"
                  data-lp-stagger-item
                >
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-cyan-300/24 bg-[linear-gradient(180deg,rgba(103,232,249,0.14),rgba(255,255,255,0.04))] p-px shadow-[0_34px_90px_rgba(0,0,0,0.34)]">
              <div className="pointer-events-none absolute inset-0 rounded-[32px] animate-[lp-signup-cta-pulse_4.8s_ease-in-out_infinite]" />
              ...
              <div className="relative flex h-full items-center justify-center rounded-[31px] bg-[linear-gradient(180deg,rgba(24,40,60,0.96),rgba(16,28,46,0.92))] p-4 backdrop-blur-xl sm:p-5">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-cyan-200/48 to-transparent" />
                <div className="pointer-events-none absolute inset-x-[12%] top-0 h-28 rounded-full bg-cyan-300/14 blur-3xl" />
                <div className="pointer-events-none absolute inset-px rounded-[30px] ring-1 ring-inset ring-cyan-200/10" />
