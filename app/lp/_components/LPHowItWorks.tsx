...
export default function LPHowItWorks() {
  return (
    <section className="relative mx-auto max-w-7xl px-6 pb-24 pt-16 sm:px-8 sm:pt-18 lg:px-10 lg:pt-20">
      ...
      <div className="relative overflow-hidden rounded-[36px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.022))] p-[1px] backdrop-blur-2xl">
        <div className="relative rounded-[35px] bg-[linear-gradient(180deg,rgba(8,18,30,0.90),rgba(6,16,26,0.84))] p-7 sm:p-10">
          ...
          <div className="pointer-events-none absolute inset-[1px] rounded-[34px] ring-1 ring-inset ring-white/6" />
          ...
          <div className="relative mt-10">
            <div className="pointer-events-none absolute left-[8%] right-[8%] top-10 hidden h-px bg-gradient-to-r from-cyan-300/0 via-cyan-300/38 to-cyan-300/0 lg:block" />

            <div className="grid gap-5 lg:grid-cols-3">
              {steps.map((step, index) => (
                <div
                  key={step.no}
                  className="group relative overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))] p-[1px] transition duration-300 hover:-translate-y-1 hover:border-cyan-300/18 hover:shadow-[0_20px_50px_rgba(0,0,0,0.22)]"
                  style={{
                ...
                >
                  <div className="relative h-full rounded-[27px] bg-[linear-gradient(180deg,rgba(7,17,34,0.94),rgba(6,16,28,0.88))] p-6">
                    ...
                    <div className="pointer-events-none absolute inset-[1px] rounded-[26px] ring-1 ring-inset ring-white/6" />
                    ...
                    <div className="relative flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {index < steps.length - 1 ? (
                          <div className="hidden h-px w-10 bg-gradient-to-r from-cyan-300/55 to-transparent lg:block" />
                        ) : null}
                      </div>
                    </div>
                      ...
                      {index === 1 ? (
                        <div className="rounded-[20px] border border-white/8 bg-white/[0.03] p-4">
                          ...
                          <div className="mt-4 h-2 rounded-full bg-white/8">
                            <div className="h-2 w-[82%] rounded-full bg-gradient-to-r from-cyan-300 via-sky-400 to-emerald-300" />
                          </div>
                    ...
                    <div className="relative mt-5 h-1 w-0 rounded-full bg-gradient-to-r from-cyan-300 to-emerald-300 transition-all duration-300 group-hover:w-20" />
                  </div>
                </div>
              ))}
            </div>
