// app/mobile/plan-change-complete/page.tsx
"use client";
...
const A = PRO_SUCCESS_ACCENT.planChange;
                ...
                <div className="relative flex flex-col items-center gap-2.5 overflow-hidden px-1 py-0.5">
                  ...
                  {motionOn ? (
                    <motion.span
                      ...
                      style={{
                        background:
                          "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.1) 30%, rgba(255,255,255,0.92) 50%, rgba(255,236,179,0.55) 64%, transparent 100%)",
                      }}
