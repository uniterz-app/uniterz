...
export default function ProSubscribePage() {
  ...
  const STRIPE_ENABLED = false; // 申請完了まで false
...
`}
>
  {STRIPE_ENABLED ? "Pro Planにアップグレード" : "現在準備中"}
</button>

<p className="text-center text-[11px] text-white/50 mb-4">
  ※ 現在 Stripe 審査中のため、まもなく利用可能になります
</p>
...
<div className="mb-4 text-center text-[10px] text-white/40">
  ※ 機能は順次追加・改善されます 月間データ：月初に集計・更新 
        ...
        {/* Notice */}
<div className="mb-4 text-xs text-white/60 space-y-1 text-center">
  <div className="text-xs text-white/60 mt-3">
  <p>※ プランは自動更新されます。解約はいつでも可能ですが、次回更新まで利用可能です。</p>
</div>
<div className="text-xs text-white/60 mt-3">
  <p>安全な支払いシステム（Stripe）を利用しています。ご安心ください。</p>
</div>
<div className="text-xs text-white/60 mt-3">
  <p>プラン変更はいつでも可能です。月額から年額への変更や、その逆も簡単に行えます。</p>
  <div className="text-xs text-white/60 mt-3 text-center space-y-1">
  <p>
    ※ 年額プランは途中で解約しても
