    ...
    >
        ...
        {loading && (
          <div className="space-y-5">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="rounded-none overflow-hidden bg-white/5 border border-white/10">
        ...
        {!loading && items.map((a) => {
          ...
          return (
            ...
            >
              <div
                className={[
                  "relative rounded-none overflow-hidden mb-6 border border-white/10 bg-white/5",
