...
import { declineSquadInvite } from "@/lib/groupBattles/server/invites";
...
export async function POST(req: Request, ctx: Ctx) {
  try {
    ...
    await declineSquadInvite({ db: adminDb, battleId, inviteId, uid });
    return jsonOk({ decision: "declined" as const });
  } catch (e) {
