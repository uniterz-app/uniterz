...
function TabButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={[
        "h-9 rounded-xl border px-4 text-[18px] leading-none tracking-[0.06em] transition-[color,border-color,box-shadow,text-shadow]",
        active
...
export default function RankingsCategoryTabs({
  ...
  return (
    <div className="grid grid-cols-2 gap-2 rounded-2xl border border-white/10 bg-white/3 p-1">
      <TabButton
