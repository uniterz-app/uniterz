...
export default function ScoringRulesChangeNoticeModal({
  ...
  return (
    <div
      className="fixed inset-0 z-100040 overflow-y-auto overscroll-contain"
      role="presentation"
    >
      <div
        className="flex min-h-full w-full items-center justify-center bg-black/75 p-4"
        onClick={(e) => {
      ...
      >
        <div
          ...
          className="my-4 max-h-[min(90dvh,520px)] w-full max-w-md overflow-y-auto rounded-2xl border border-white/12 bg-[#0a1220] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.55)]"
