/**
 * Firestore games → nbaTeamGameLogs スナップショット ingest。
 *
 *   npx tsx scripts/ingest-nba-team-game-logs-from-games.ts
 *   npx tsx scripts/ingest-nba-team-game-logs-from-games.ts 2026-27
 *
 * 認証: `.env.local` の FIREBASE_*
 * ※ 先に games ingest 済みであること
 */
import fs from "fs";
