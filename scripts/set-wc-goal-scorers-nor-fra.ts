/**
 * wc-2026-I-nor-fra（ノルウェー 1–4 フランス）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   7'  ウスマン・デンベレ（フランス）
 *   20' ウスマン・デンベレ（フランス）
 ...
 *
 *   npx tsx scripts/set-wc-goal-scorers-nor-fra.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-nor-fra.ts
 *   npx tsx scripts/set-wc-goal-scorers-nor-fra.ts --with-score
 *   npx tsx scripts/set-wc-goal-scorers-nor-fra.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-nor-fra.ts --force
 *
 * オプション:
 *   --dry-run     書き込まず内容を表示
...
const DEFAULT_GAME_ID = "wc-2026-I-nor-fra";
