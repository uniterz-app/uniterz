/**
 * BDL → Firestore games ingest。
 *
 *   npx tsx scripts/ingest-nba-games-from-bdl.ts
 *   npx tsx scripts/ingest-nba-games-from-bdl.ts 2026-27
 *   npx tsx scripts/ingest-nba-games-from-bdl.ts 2025-26 --dry-run
 *
