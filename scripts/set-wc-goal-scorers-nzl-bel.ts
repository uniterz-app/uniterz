/**
 * wc-2026-G-nzl-bel（ニュージーランド 1–5 ベルギー）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   28' レアンドロ・トロサール（ベルギー）
 *   50' レアンドロ・トロサール（ベルギー）
 *   66' ケヴィン・デ・ブライネ（ベルギー）
 *   84' イライジャー・ジャスト（ニュージーランド）
 *   86' ロメル・ルカク（ベルギー）
 *   90+4' アレクシス・サレマーケーズ（ベルギー）
 *
 *   npx tsx scripts/set-wc-goal-scorers-nzl-bel.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-nzl-bel.ts --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-G-nzl-bel";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "bel-trossard", teamId: "wc-bel", minute: 28 },
  { playerId: "bel-trossard", teamId: "wc-bel", minute: 50 },
  { playerId: "bel-bruyne", teamId: "wc-bel", minute: 66 },
  { playerId: "nzl-just", teamId: "wc-nzl", minute: 84 },
  { playerId: "bel-lukaku", teamId: "wc-bel", minute: 86 },
  { playerId: "bel-saelemaekers", teamId: "wc-bel", minute: 94 },
];
