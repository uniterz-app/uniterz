/**
 * wc-2026-I-sen-irq（セネガル 5–0 イラク）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   4'  アビブ・ディアッラ（セネガル）
 *   56' イスマイラ・サール（セネガル）
 ...
 *
 *   npx tsx scripts/set-wc-goal-scorers-sen-irq.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-sen-irq.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-sen-irq.ts --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-I-sen-irq";
...
(async () => {
  ...
  if (WITH_SCORE) {
    console.log("score: 5 - 0, final: true");
  }
