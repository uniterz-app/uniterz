/**
 * wc-2026-L-gha-pan（ガーナ 1–0 パナマ）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   90+5' カレブ・イレンキ（ガーナ）
 *
 ...
 *
 *   npx tsx scripts/set-wc-goal-scorers-gha-pan.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-gha-pan.ts
 *   npx tsx scripts/set-wc-goal-scorers-gha-pan.ts --with-score
 *   npx tsx scripts/set-wc-goal-scorers-gha-pan.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-gha-pan.ts --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-L-gha-pan";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "gha-yirenkyi", teamId: "wc-gha", minute: 95 },
];
