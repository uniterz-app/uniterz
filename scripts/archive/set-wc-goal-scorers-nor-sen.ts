/**
 * wc-2026-I-nor-sen（ノルウェー 3–2 セネガル）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   43' マルクス・ホルムグレン・ペデルセン（ノルウェー）
 *   48' アーリング・ブラウト・ハーランド（ノルウェー）
 *   53' イスマイラ・サール（セネガル）
 *   58' アーリング・ブラウト・ハーランド（ノルウェー）
 *   90+3' イスマイラ・サール（セネガル）
 *
 * 前提: プロジェクトルートに service-account.json または serviceAccount.json
 *
 *   npx tsx scripts/set-wc-goal-scorers-nor-sen.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-nor-sen.ts --with-score
 *   npx tsx scripts/set-wc-goal-scorers-nor-sen.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-nor-sen.ts --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-I-nor-sen";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "nor-pedersen", teamId: "wc-nor", minute: 43 },
  { playerId: "nor-haaland", teamId: "wc-nor", minute: 48 },
  { playerId: "sen-sarr-3", teamId: "wc-sen", minute: 53 },
  { playerId: "nor-haaland", teamId: "wc-nor", minute: 58 },
  { playerId: "sen-sarr-3", teamId: "wc-sen", minute: 93 },
];
