/**
 * wc-2026-ko-M93（ポルトガル 0–1 スペイン・R16）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   90+1' ミケル・メリーノ（スペイン）
 *
 *   npx tsx scripts/set-wc-goal-scorers-prt-esp.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-prt-esp.ts --with-score --resettle --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-ko-M93";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "esp-merino", teamId: "wc-esp", minute: 91 },
];
