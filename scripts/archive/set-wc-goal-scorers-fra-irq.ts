/**
 * wc-2026-I-fra-irq（フランス 3–0 イラク）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   14' キリアン・エムバペ（フランス）
 *   54' キリアン・エムバペ（フランス）
 ...
 *
 *   npx tsx scripts/set-wc-goal-scorers-fra-irq.ts --dry-run
 *   npx tsx scripts/set-wc-goal-scorers-fra-irq.ts
 *   npx tsx scripts/set-wc-goal-scorers-fra-irq.ts --with-score
 *   npx tsx scripts/set-wc-goal-scorers-fra-irq.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-fra-irq.ts --force
 *
 * オプション:
 *   --dry-run     書き込まず内容を表示
...
const DEFAULT_GAME_ID = "wc-2026-I-fra-irq";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "fra-mbappe", teamId: "wc-fra", minute: 14 },
  { playerId: "fra-mbappe", teamId: "wc-fra", minute: 54 },
