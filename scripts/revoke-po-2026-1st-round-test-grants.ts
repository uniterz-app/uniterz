/**
 * テスト付与した PO 1st Round 4バッジを user_badges から削除（本番付与前の試し削除など）
 *
 *   npm run badges:po1:revoke-test
 *   TEST_UID=xxxx npx tsx scripts/revoke-po-2026-1st-round-test-grants.ts
 */
...
async function main() {
  console.log(`=== revoke PO 1st round test grants for ${TEST_UID} ===`);
