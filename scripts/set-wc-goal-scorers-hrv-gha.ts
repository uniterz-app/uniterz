/**
 * wc-2026-L-hrv-gha（クロアチア 2–1 ガーナ）の goalScorers を Firestore に投入。
 *
 * 得点:
 *   31' ペタル・スチッチ（クロアチア）
 *   73' デリク・ルカセン（ガーナ）
 *   83' ニコラ・ヴラシッチ（クロアチア）
 *
 *   npx tsx scripts/set-wc-goal-scorers-hrv-gha.ts --with-score --resettle
 *   npx tsx scripts/set-wc-goal-scorers-hrv-gha.ts --force
 */
...
const DEFAULT_GAME_ID = "wc-2026-L-hrv-gha";

const GOAL_SCORERS: WcGameGoalScorer[] = [
  { playerId: "hrv-sucic", teamId: "wc-hrv", minute: 31 },
  { playerId: "gha-luckassen", teamId: "wc-gha", minute: 73 },
  { playerId: "hrv-vlasic", teamId: "wc-hrv", minute: 83 },
];
