/**
 * 案 F — 通過（U）
 * 案 E と同じトンネル通過だが、対象はヘッダー左の直立 U マーク。
 */
...
const CONCEPT = getVoidCoronaConcept("F");
...
export default function VoidCoronaSplashFNative({
  playKey = 0,
  forceStatic = false,
  onComplete,
}: Props) {
  ...
  // DEV プレビューでは終端を真っ黒のままにしない（「もう一度再生」が消えて見えるため）
