...
exports.WC_KNOCKOUT_WIN_RATE_MIN_POSTS = exports.WC_GROUP_STAGE_WIN_RATE_MIN_POSTS = exports.WC_OVERALL_WIN_RATE_MIN_POSTS = exports.WC_RANKING_STAGES = void 0;
...
exports.WC_KNOCKOUT_WIN_RATE_MIN_POSTS = 4;
function minPostsForWcWinRate(stage) {
    ...
    if (stage === "main")
        return exports.WC_KNOCKOUT_WIN_RATE_MIN_POSTS;
    return 1;
}
