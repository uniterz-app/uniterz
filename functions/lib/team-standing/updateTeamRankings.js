...
const nbaStandingsSeasonTiebreak_1 = require("./nbaStandingsSeasonTiebreak");
const db = (0, firestore_1.getFirestore)();
function readTiebreakOrder(data) {
...
function rankGroupKey(league, conferenceRaw) {
    ...
    Object.keys(groups).forEach((gk) => {
        ...
        teams.sort((a, b) => {
            ...
            if (gk.startsWith("nba:")) {
                const seasonTb = (0, nbaStandingsSeasonTiebreak_1.compareNbaStandingsSeasonTiebreak)(a.id, b.id);
                if (seasonTb !== 0)
                    return seasonTb;
            }
