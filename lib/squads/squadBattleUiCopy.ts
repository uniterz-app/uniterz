...
export function squadBattleRulesSection(lang: SquadBattleUiLang = "ja"): {
  ...
  return {
    ...
    items: Ls(lang, [
      ...
      {
        ja: "週間1位は全員30 Unit、月間1位は全員100 Unit（上位20まで）",
        en: "Weekly 1st pays 30 Units each, monthly 1st pays 100 each (top 20 paid)",
        ko: "주간 1위 전원 30 Unit, 월간 1위 전원 100 Unit (상위 20까지)",
        zh: "周冠军每人 30 Unit，月冠军每人 100 Unit（前 20 名）",
        es: "1.º semanal: 30 Units c/u; 1.º mensual: 100 c/u (top 20)",
        pt: "1.º semanal: 30 Units cada; 1.º mensal: 100 cada (top 20)",
        fr: "1er hebdo : 30 Units chacun ; 1er mensuel : 100 chacun (top 20)",
      },
      {
...
export function squadBattlePhaseBanner(args: {
  ...
  return {
    ...
    detail: L(lang, {
      ja: "週間1位はメンバー全員に 30 Unit、月間1位は 100 Unit。上位20グループまで順位に応じた Unit を確定メンバー全員へ同額付与します。",
      en: "Weekly 1st pays 30 Units to every member, monthly 1st pays 100. The top 20 squads all earn rank-based Units, paid equally to every locked member.",
      ko: "주간 1위는 전원 30 Unit, 월간 1위는 100 Unit. 상위 20 스쿼드까지 순위별 Unit을 확정 멤버 전원에게 동일 지급.",
      zh: "周冠军每人 30 Unit，月冠军 100 Unit。前 20 名小队按排名发放 Unit，锁定成员等额获得。",
      es: "1.º semanal: 30 Units por miembro; 1.º mensual: 100. Top 20 escuadras reciben Units según puesto, repartidos por igual.",
      pt: "1.º semanal: 30 Units por membro; 1.º mensal: 100. Top 20 esquadrões recebem Units por posição, iguais para todos.",
      fr: "1er hebdo : 30 Units par membre ; 1er mensuel : 100. Top 20 escouades reçoivent des Units selon le rang, part égales.",
    }),
    tone: "reward",
  };
}
  ...
  return {
    ...
    facts: [
      ...
      },
      {
        kicker: "REWARD",
        value: L(lang, {
          ja: "週1位 30 · 月1位 100 Unit（全員）",
          en: "Weekly 1st 30 · monthly 1st 100 Units (each)",
          ko: "주간 1위 30 · 월간 1위 100 Unit (전원)",
          zh: "周冠军 30 · 月冠军 100 Unit（每人）",
          es: "1.º semanal 30 · 1.º mensual 100 Units (c/u)",
          pt: "1.º semanal 30 · 1.º mensal 100 Units (cada)",
          fr: "1er hebdo 30 · 1er mensuel 100 Units (chacun)",
        }),
      },
    ],
  };
