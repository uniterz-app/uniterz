...
export function notificationProGateCopy(
  ...
  return {
    ...
    body: L(lang, {
      ja: "欠場・先発・Insight など、予想を見直す材料だけが届きます。",
      en: "Injury, lineup, and Insight — only when you should recheck a pick.",
      ko: "결장·선발·Insight 등 예측을 다시 볼 재료만 도착합니다.",
      zh: "仅在伤停、首发、Insight 等需要重看预测时推送。",
      es: "Lesión, alineación e Insight: solo cuando debas revisar tu pick.",
      pt: "Lesão, escalação e Insight — só quando vale rever o palpite.",
      fr: "Blessure, composition et Insight — seulement pour revoir un pick.",
    }),
    priceLabel: "Monthly",
    price: "¥780",
    period: L(lang, {
    ...
    bullets: [
      {
        ...
        detail: L(lang, {
          ja: "欠場・先発変更。締切は 60 / 10 分前も選べる",
          en: "Injury / lineup. Deadline also unlocks 60 / 10 min",
          ko: "결장·선발 변경. 마감 60/10분 전도 선택 가능",
          zh: "伤停/首发变更。截止也可选赛前 60/10 分钟",
          es: "Lesión / alineación. Cierre también a 60 / 10 min",
          pt: "Lesão / escalação. Prazo também 60 / 10 min",
          fr: "Blessure / composition. Deadline aussi 60 / 10 min",
        }),
      },
      {
        title: "Pro Insight",
