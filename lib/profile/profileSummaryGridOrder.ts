 ...
 * - Pro: `WebProfileViewV2` は Row1 が AnalysisWin | MaxStreak、Row2 が Upset | Total。
 *   `MobileProfileViewV2` も Row1 が AnalysisWin（広）| MaxStreak、Row2 が Upset、Row3 が Total 幅広。
 ...
 * posts → winrate → max streak → upset → total
 */
