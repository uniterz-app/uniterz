...
export const DIRECT_PLAYER_IDS: Record<string, Record<string, string>> = {
  ...
  bra: { Cunha: "bra-cunha", Gabriel: "bra-magalhaes", "Alex Sandro": "bra-santos", Martinelli: "bra-martinelli", Ibañez: "bra-ibanez", "Igor Thiago": "bra-thiago", Paquetá: "bra-paqueta", "Vinícius Júnior": "bra-junior", Danilo: "bra-luiz", Rayan: "bra-rayan", Guimarães: "Bruno Guimarães", Vinícius: "Vinícius Júnior" },
  civ: {
  ...
  mar: { Bono: "mar-bounou", Mazraoui: "mar-mazraoui", Abde: "mar-ezzalzouli", Diop: "mar-diop", Bounou: "mar-bounou", Riad: "mar-riad", Bouaddi: "mar-bouaddi", Saibari: "mar-saibari", Hakimi: "mar-hakimi", "El Aynaoui": "mar-aynaoui", "El Khannouss": "mar-khannouss", Ounahi: "mar-ounahi", "Brahim Díaz": "mar-diaz", Aguerd: "mar-aguerd", Amrabat: "mar-amrabat", Saïss: "mar-saiss", Saiss: "mar-saiss", "En-Nesyri": "mar-en-nesyri", Rahimi: "mar-rahimi" },
  pry: {
    Gill: "pry-gill",
...
export const MANUAL_ALIASES: Record<string, Record<string, string>> = {
  ...
  bel: { "De Cuyper": "Maxim De Cuyper", "De Ketelaere": "Charles De Ketelaere", Meunier: "Thomas Meunier", "De Winter": "Zeno Debast", Castagne: "Timothy Castagne", Ngoy: "Nathan Ngoy", Mechele: "Brandon Mechele", "Fernandez-Pardo": "Matias Fernandez-Pardo", "Fernandez Pardo": "Matias Fernandez-Pardo", Doku: "bel-doku", Lukaku: "bel-lukaku" },
  ...
  egy: { Abdelmaguif: "Abdelmonem", Hany: "Mohamed Hany", Lasheen: "Mohanad Lasheen", Fatouh: "Ahmed Fatouh", "El Hanafi": "Tarek Alaa", "El Fetouh": "Mohamed Abdelmonem", Ibrahim: "Yasser Ibrahim", Attia: "Marwan Attia", Fathi: "Hamdy Fathy", Zizo: "Zizo" },
  ...
  mar: { "Salah-Eddine": "Anass Salah-Eddine", "El Aynaoui": "Neil El Aynaoui", "El Kaabi": "Ayoub El Kaabi", "Brahim Diaz": "Brahim Díaz", Saïss: "mar-saiss", Saiss: "mar-saiss", "En-Nesyri": "mar-en-nesyri" },
  ...
  pry: { Gill: "Antony Silva", "G. Gomez": "Gustavo Gómez", "Gustavo Gómez": "Gustavo Gómez", "D. Gomez": "Diego Gómez", Avalos: "Gabriel Ávalos" },
