...
const WC_TEAM_PROFILES: Record<string, WcTeamProfile> = {
  ...
  bra: {
    ...
    description: {
      en: "The most successful nation in World Cup history and the only side to have appeared in every edition. Title-less since 2002 and inconsistent in CONMEBOL qualifying recently. Vinícius Júnior, Rodrygo and Endrick lead one of the world's best attacks; the goal is a sixth crown, with defensive stability and team cohesion the open questions.",
      ja: "唯一すべてのW杯に出場している最多優勝国。2002年以降は優勝から遠ざかっており、近年は南米予選でも不安定さを見せた。Vinícius Júnior、Rodrygo、Endrickら攻撃陣の個の力は世界最高級。目標は6度目の優勝で、課題は守備の安定とチームとしてのまとまり。",
    },
    fifaRank: 6,
    wcAppearances: 22,
    wcTitles: 5,
  ...
  civ: {
    ...
    confederation: "CAF",
    description: {
      en: "Once defined by the Drogba generation, Côte d'Ivoire are now rebuilding around a new wave. They have failed to escape their group in three previous attempts. Athleticism, intensity and individual quality up front—led by Simon Adingra and Sébastien Haller—are the calling cards. The goal is a first-ever knockout berth.",
      ja: "Drogba世代の印象が強い国だが、現在は新しい世代で再構築している。過去3度のW杯ではすべてグループステージ敗退で、まだ決勝トーナメント進出がない。身体能力、強度、前線の個が武器で、Simon Adingra、Sébastien Hallerらが中心になる。目標は国として初のグループ突破。",
    },
    fifaRank: 34,
    wcAppearances: 3,
    wcTitles: 0,
  ...
  jpn: {
    ...
    confederation: "AFC",
    description: {
      en: "Made global headlines in 2022, beating Germany and Spain to top the group, before losing to Croatia on penalties in the round of 16—again falling short of a first quarterfinal. The Europe-based core of Kubo, Mitoma, Endo, Tomiyasu and Doan is the deepest in the country's history. Beyond rapid counterattacks, the side now has the ability to break opponents down with the ball; the goal is a first-ever quarterfinal run.",
      ja: "前回の2022年大会ではドイツとスペインを倒してグループ首位通過を果たし、世界に大きな衝撃を与えた。一方で、ベスト16ではクロアチアにPK戦で敗れ、またしてもベスト8の壁を越えられなかった。今回は久保建英、三笘薫、遠藤航、冨安健洋、堂安律ら欧州組が中心で、選手層は過去最高級。速攻だけでなく、ボールを持って崩す力も上がっており、目標は日本サッカー初のベスト8以上。",
    },
    fifaRank: 18,
    wcAppearances: 7,
    wcTitles: 0,
  ...
  irn: {
    ...
    confederation: "AFC",
    description: {
      en: "Asian heavyweights who have never advanced from the World Cup group stage. Built around Mehdi Taremi and Sardar Azmoun, leaning on a defensive block and quick counters. Political concerns around tournament participation have been reported, but at present they remain in the field. The goal is a first-ever knockout berth.",
      ja: "アジア予選では安定して強いが、W杯本大会ではまだ決勝トーナメントに進んだことがない。Mehdi Taremi、Sardar Azmounら経験豊富な攻撃陣を中心に、守備を固めてカウンターで仕留める形が基本。政治的な問題で大会参加を巡る懸念も報じられているが、現時点では出場国に含まれる。目標は国として初のグループ突破。",
    },
    fifaRank: 21,
    wcAppearances: 6,
    wcTitles: 0,
  ...
  jor: {
    ...
    confederation: "AFC",
    description: {
      en: "First-ever World Cup. Built momentum at the Asian Cup with a counter-attacking style; Mousa Al-Taamari leads the front line with pace and resilience defining the team. As a debutant nation, the goals are a first World Cup point and, if possible, a first win.",
      ja: "国として初のW杯出場。近年はアジアカップで存在感を高め、守備から速く攻めるスタイルで評価を上げてきた。Mousa Al-Taamariらを中心に、前線のスピードと粘り強い守備が武器になる。初出場国としてまずは勝ち点獲得、可能なら初勝利が大きな目標。",
    },
    fifaRank: 63,
    wcAppearances: 0,
    wcTitles: 0,
  ...
  prt: {
    ...
    confederation: "UEFA",
    description: {
      en: "Transitioning from the Cristiano Ronaldo era to a deep generation including Bruno Fernandes, Bernardo Silva, Rafael Leão and João Félix. Among Europe's most talent-rich attacks, with countless options going forward. The questions are rotation discipline and tournament-long defensive consistency; the goal is a first World Cup title.",
      ja: "Cristiano Ronaldoの時代から、Bruno Fernandes、Bernardo Silva、Rafael Leão、João Félixらを擁する厚い世代へ移っている。タレント量では欧州トップ級で、攻撃の選択肢は非常に多い。課題はスター選手の使い分けと、大会を通した守備の安定。目標は国として初のW杯優勝。",
    },
    fifaRank: 5,
    wcAppearances: 8,
    wcTitles: 0,
  ...
  gha: {
    ...
    confederation: "CAF",
    description: {
      en: "Reached the quarterfinals in 2010 and came within one penalty of becoming the first African nation to make a World Cup semifinal. Athleticism, vertical speed and individual flair up front are strengths, though consistency has been a recent issue. Mohammed Kudus and Iñaki Williams lead the attack; the goal is escaping the group, ideally another 2010-style run.",
      ja: "2010年大会でベスト8まで進み、アフリカ勢初のベスト4にあと一歩まで迫った国。身体能力、縦への速さ、前線の個の力が武器だが、近年は安定感に課題もある。Mohammed Kudus、Iñaki Williamsらが攻撃の中心になる。目標はグループ突破、理想は2010年のような躍進。",
    },
    fifaRank: 74,
    wcAppearances: 4,
    wcTitles: 0,
