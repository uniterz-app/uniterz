/** グループ一覧スロットカード — 背景画像＋暗幕（黒） */

export const COMMUNITY_GROUP_SLOT_CARD_BG = "#000000";

/** 左テキスト帯を確保しつつ右側に画像が覗くグラデーション */
export const COMMUNITY_GROUP_SLOT_CARD_SCRIM_OWNER =
  "linear-gradient(90deg, rgba(0,0,0,0.96) 0%, rgba(0,0,0,0.9) 26%, rgba(0,0,0,0.62) 46%, rgba(0,0,0,0.28) 68%, rgba(0,0,0,0.1) 100%)";

export const COMMUNITY_GROUP_SLOT_CARD_SCRIM_MEMBER =
  "linear-gradient(90deg, rgba(0,0,0,0.94) 0%, rgba(0,0,0,0.86) 28%, rgba(0,0,0,0.58) 48%, rgba(0,0,0,0.26) 70%, rgba(0,0,0,0.08) 100%)";

/** 右上バッジ帯 — 明るい画像でもオーナー表示を読みやすく */
export const COMMUNITY_GROUP_SLOT_CARD_SCRIM_TOP =
  "linear-gradient(180deg, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.42) 42%, rgba(0,0,0,0) 72%)";
...
export const COMMUNITY_GROUP_SLOT_CARD_NATIVE_SCRIM_TOP = {
  colors: ["rgba(0,0,0,0.78)", "rgba(0,0,0,0.42)", "rgba(0,0,0,0)"] as const,
