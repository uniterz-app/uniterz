...
const COPY: Record<string, DetailChipCopy> = {
  ...
  first_option: {
    hint: {
      ja: "チーム内の第1得点源。所属チームの出場選手で PPG 1位。",
      en: "Primary scoring option — #1 PPG among teammates with minutes.",
      ko: "팀 내 1옵션 득점원. 팀 출전 선수 중 PPG 1위.",
      zh: "队内第一得分点。队内有上场时间球员中 PPG 第1。",
      es: "Primera opción ofensiva: #1 en PPG entre compañeros con minutos.",
      pt: "Primeira opção ofensiva: #1 em PPG entre companheiros com minutos.",
      fr: "Première option offensive : #1 PPG parmi les coéquipiers avec minutes.",
    },
  },
  second_option: {
    hint: {
      ja: "チーム内の第2得点源。所属チームの出場選手で PPG 2位。",
      en: "Secondary scoring option — #2 PPG among teammates with minutes.",
      ko: "팀 내 2옵션 득점원. 팀 출전 선수 중 PPG 2위.",
      zh: "队内第二得分点。队内有上场时间球员中 PPG 第2。",
      es: "Segunda opción ofensiva: #2 en PPG entre compañeros con minutos.",
      pt: "Segunda opção ofensiva: #2 em PPG entre companheiros com minutos.",
      fr: "Deuxième option offensive : #2 PPG parmi les coéquipiers avec minutes.",
    },
  },
  third_option: {
    hint: {
      ja: "チーム内の第3得点源。所属チームの出場選手で PPG 3位。",
      en: "Tertiary scoring option — #3 PPG among teammates with minutes.",
      ko: "팀 내 3옵션 득점원. 팀 출전 선수 중 PPG 3위.",
      zh: "队内第三得分点。队内有上场时间球员中 PPG 第3。",
      es: "Tercera opción ofensiva: #3 en PPG entre compañeros con minutos.",
      pt: "Terceira opção ofensiva: #3 em PPG entre companheiros com minutos.",
      fr: "Troisième option offensive : #3 PPG parmi les coéquipiers avec minutes.",
    },
  },
  primary_handler: {
    hint: {
