/**
 * Referral invite 画面 chrome・ステータス（7言語）。
 * Web `ReferralInvitePage` / Native `ReferralInviteScreenNative` 共有。
 */
...
export function referralInviteScreenCopy(language: string | null | undefined) {
  ...
  return {
    lang,
    description: L(lang, {
      ja: "友達を招待して Unit を獲得。友達はコード入力で 30 Unit、あなたは相手が7日間予想すると受け取れます。",
      en: "Invite friends for Units. They get 30 Units when they enter your code; you earn after they predict on 7 days.",
      ko: "친구를 초대해 Unit을 획득. 친구는 코드 입력 시 30 Unit, 당신은 상대가 7일 예상하면 받습니다.",
      zh: "邀请好友赚 Unit。好友输入邀请码即得 30 Unit，你在对方完成 7 天预测后获得。",
      es: "Invita amigos por Units. Ellos reciben 30 al poner tu código; tú ganas tras 7 días de picks.",
      pt: "Convide amigos por Units. Eles ganham 30 ao digitar seu código; você após 7 dias de picks.",
      fr: "Invitez des amis pour des Units. Ils reçoivent 30 avec votre code ; vous après 7 jours de picks.",
    }),
    loading: L(lang, {
      ja: "読み込み中…",
      en: "Loading…",
    ...
    inviteProgress: L(lang, {
      ja: "招待の進捗",
      en: "Invite progress",
      ko: "초대 진행",
      zh: "邀请进度",
      es: "Progreso de invitaciones",
      pt: "Progresso dos convites",
      fr: "Progression des invitations",
    }),
    copyFailed: L(lang, {
      ja: "コピーに失敗しました",
      en: "Copy failed",
    ...
    inviteTextCopied: L(lang, {
      ja: "招待文をコピーしました",
      en: "Invite text copied",
      ko: "초대 문구를 복사했습니다",
      zh: "已复制邀请文案",
      es: "Texto de invitación copiado",
      pt: "Texto de convite copiado",
      fr: "Texte d’invitation copié",
    }),
    shareTitle: L(lang, {
      ja: "Uniterz に招待",
      en: "Join me on Uniterz",
      ko: "Uniterz에 초대",
      zh: "邀请加入 Uniterz",
      es: "Únete a Uniterz",
      pt: "Entre no Uniterz",
      fr: "Rejoins-moi sur Uniterz",
    }),
    ...
    grantNote: L(lang, {
      ja: "あなたへの付与は、友達が異なる7日に有効予想を投稿したあと。友達本人はコード入力時に 30 Unit を受け取ります。",
      en: "You earn after they post on 7 different days. They get 30 Units when they enter your code.",
      ko: "당신 지급은 친구가 서로 다른 7일에 유효 예상을 올린 뒤. 친구는 코드 입력 시 30 Unit을 받습니다.",
      zh: "你在好友于 7 个不同日期发布有效预测后获得。好友输入邀请码时即得 30 Unit。",
      es: "Tú ganas tras 7 días distintos de picks. Ellos reciben 30 Units al introducir tu código.",
      pt: "Você ganha após 7 dias distintos de picks. Eles recebem 30 Units ao digitar seu código.",
      fr: "Vous gagnez après 7 jours distincts de picks. Ils reçoivent 30 Units en saisissant votre code.",
    }),
    active: L(lang, {
      ja: "進行中",
      en: "Active",
