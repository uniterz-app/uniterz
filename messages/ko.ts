...
const ko: Messages = {
  ...
  rankings: {
    ...
    shareCaptionCopy: "문구 복사",
    shareCaptionCopied: "문구를 복사했습니다",
  ...
  results: {
    ...
    shareResultCardTitle: "결과 공유",
    shareResultCardHint: "Instagram · LINE · X 등으로 이미지를 바로 보낼 수 있습니다",
  ...
  settings: {
    ...
    sectionSupport: "지원",
    sectionAdmin: "관리",
    adminFeatureRequests: "기능 요청",
    adminContacts: "문의",
    adminRedemptions: "상품 교환 신청",
    helpDescription:
  ...
  predict: {
    ...
    pastResults: "이전 경기",
    pastResultsEmpty: "아직 종료된 경기가 없습니다.",
    pastResultWin: "승",
    pastResultDraw: "무",
    pastResultLoss: "패",
    distribution: "예측 분포",
  ...
  tutorial: {
    ...
    hybrid: {
      ...
      welcomeTitle: "예측하고 포인트를 잡아라",
      welcomeBody: "적중이 순위가 된다. 한 경기로 게시→결과→랭킹 흐름을 체감하라.",
    ...
    practice: {
      ...
      predictToolsWait: "위 탭을 눌러 전환할 수 있습니다",
