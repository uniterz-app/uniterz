...
const en: Messages = {
  ...
  profile: {
    ...
    noStatsYet: "No predictions yet",
    noStatsYetSub: "Make your first pick and your stats will show up here.",
    noStatsYetOther: "This user hasn't made any predictions yet.",
    makeFirstPick: "Make your first pick",
    last7d: "Last 7d",
    last30d: "Last 30d",
    ...
    last20TrackerUnavailable: "Couldn't load data",
  ...
  rankings: {
    ...
    shareMyRank: "Share my rank card as an image",
    ...
    shareCaptionCopy: "Copy message",
    shareCaptionCopied: "Message copied",
    ...
    shareRankCardText: "{league} rankings — #{rank} of {total} players #Uniterz",
    shareRankCardTextNoTotal: "{league} rankings — currently #{rank} #Uniterz",
    yourRank: "YOUR RANK",
    ...
    winRatePickupRateRequired:
      "Win Rate ranking requires predicting at least 65% of pickup games available so far.",
    ...
    rankShadow: {
      title: "Rival band",
      subtitle: "Track how rivals in last week's band moved this week.",
      ...
      priorBand: "Ranks {low}–{high} (you were #{rank} last week)",
      cohortCountLabel: "Rivals",
      cohortSize: "{n} in this band last week",
      liveRank: "THIS WEEK",
      ...
      compareHint: "This week's gains vs the band average since last week",
      compareYouLabel: "YOU",
      compareCohortLabel: "Band avg",
      cohortAvgBand: "Band avg {value}",
      cohortBandDelta: "vs band {delta}",
      axisRank: "Rank change",
      axisExactHits: "Exact scores",
      axisStreakBonus: "Streak bonus",
      axisUpsetBonus: "Upset bonus",
      vsCohort: "vs band",
      ...
      weekBoundNote:
        "Weeks start Sunday 0:00 JST. This week's totals accumulate from each Sunday.",
      bonusMetricNote:
        "Streak and goal-scorer weekly comparisons become more accurate after daily snapshots are stored.",
    },
  },
  ...
  results: {
    ...
    dayTotalScoreAria: "Score for this day: {pts} pts.",
    filterTitle: "Filters",
    filterReset: "Reset",
    filterClose: "Close",
  ...
  games: {
    ...
    standingsPredict: "Standings Predictions",
    statsSection: "STATS",
  ...
  tutorial: {
    ...
    hybrid: {
      ...
      flowTitle: "It's simple",
      flowBody:
        "Tap a match card → pick winner & score → climb the ranks when you hit.",
      startKicker: "READY",
      startTitle: "Make your first pick",
      startBody:
        "After this, a match card will glow. Tap it and submit your first prediction.",
    },
    practice: {
      tabGames: "Games",
      tabResult: "Results",
      ...
      guideBody:
        "Winner is set from scores. Enter **HOME / AWAY**, then submit.",
      startPredict: "Make a pick",
      inputTitle: "Enter scores",
      inputBody:
        "Fill **HOME and AWAY**. HIT / MISS appear on Results after the game.",
      predictScoresTitle: "Score inputs",
      predictScoresBody:
        "**HOME / AWAY predicted scores** go here. Winner is set from these.",
      predictOverviewTitle: "Prediction screen",
      predictOverviewBody:
        "Post a score pick — Results shows **HIT / MISS** after the game.",
      predictSidesTitle: "HOME and AWAY",
      predictSidesBody: "**Left is HOME, right is AWAY.** Same layout for scores.",
      predictMarketTitle: "Market bias",
      predictMarketBody: "**How other users are leaning** — at a glance.",
      predictToolsTitle: "Info tabs",
      predictToolsBody:
        "**INSIGHT (Pro), INJURY, STATS, ROSTER** — check before you submit.",
      ...
      postedTitle: "Now we wait",
      postedBody:
        "In live games, **HIT / MISS only appear after the final.** Next: that Results moment.",
      resolvingTitle: "Game final…",
      resolvingBody: "Mock game ended. Tallying…",
      resolvingSpin: "FINALIZING",
      gotoResultsTitle: "Check Results",
      gotoResultsBody: "Outcomes land on **Results**. Tap the tab or Next.",
      gotoRankingsTitle: "Open Rankings",
      gotoRankingsBody: "Next: **Rankings**. Tap the tab or Next.",
      gotoGroupsTitle: "Open Groups",
      gotoGroupsBody: "Next: **Groups**. Tap the tab or Next.",
      ...
      profileBody:
        "**Your home base.** Stats, UNIT, settings, and plans live here.",
      profileMockStats: "Hit rate · Streak · Total points",
      horizonFeatureTag: "New",
